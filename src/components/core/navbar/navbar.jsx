...
const Navbar = () => {
  return (
    <div className="fixed z-10 w-screen bg-white/70 dark:bg-black/70 backdrop-filter backdrop-blur-md">
      <div className="wrapper h-full py-4 md:py-4 flex gap-10">
        <Link href="/">
          ...
          <button className="bg-transparent h-fit no-underline group cursor-pointer relative shadow-2xl shadow-zinc-900 rounded-full p-px text-xs font-semibold leading-6  text-white inline-block">
            <Link href={"/"}>
              ...
              <div className="relative flex space-x-2 items-center z-10 rounded-full bg-zinc-950 py-0.5 px-4 ring-1 ring-white/10 ">
                <span className="text-[0.9rem] font-normal">Contact Sales</span>
                <svg
                  fill="none"
                  height="16"
                  viewBox="0 0 24 24"
